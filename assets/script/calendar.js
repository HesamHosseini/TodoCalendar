(function () {
  ...
  function formatIsoTimeString(marker) {
    return (
      padStart$1(marker.getUTCHours(), 2) +
      ":" +
      padStart$1(marker.getUTCMinutes(), 2) +
      ":" +
      padStart$1(marker.getUTCSeconds(), 2)
    );
  }
  function formatTimeZoneOffset(minutes, doIso = false) {
    ...
    if (doIso) {
      return `${sign + padStart$1(hours, 2)}:${padStart$1(mins, 2)}`;
    }
    return `GMT${sign}${hours}${mins ? `:${padStart$1(mins, 2)}` : ""}`;
  }
        ...
        if (buttonName === "title") {
          ...
          children.push(
            y(
              ...
              buttonText ||
                (buttonIcon ? y("span", { className: buttonIcon }) : "")
            )
          );
        }
      }
      ...
      if (this.hiddenConsumes && touchingEntry) {
        ...
        if (!forceHidden[touchingEntryId]) {
          if (this.allowReslicing) {
            const placeholderEntry = Object.assign(
      ...
      if (
        ...
        this.safeSetState({
          ...
          eventInstanceHeights: Object.assign(
            Object.assign({}, oldInstanceHeights),
            newInstanceHeights
          ),
  ...
  var dateInTimeZone = function (date, timeZone) {
    ...
    var dateInTargetTZ = new Date(
      dateTZtoISO8601(
        date,
        timeZone !== null && timeZone !== void 0 ? timeZone : "UTC"
      )
    );
  ...
  var ToText = /** @class */ (function () {
    ...
    ToText.prototype.weekdaytext = function (wday) {
      ...
      return (
        (wday.n ? this.nth(wday.n) + " " : "") + this.language.dayNames[weekday]
      );
    };
  ...
  ToText.IMPLEMENTED[Frequency.YEARLY] = ["byweekno", "byyearday"].concat(
    common
  );
  // =============================================================================
  // Export
  ...
  var DateTime = /** @class */ (function (_super) {
    ...
    DateTime.prototype.addMinutes = function (
      minutes,
      filtered,
      byhour,
      byminute
      ...
      if (filtered) {
        // Jump to one iteration before next day
        this.minute +=
          Math.floor((1439 - (this.hour * 60 + this.minute)) / minutes) *
          minutes;
      }
      for (;;) {
        this.minute += minutes;
    ...
    DateTime.prototype.addSeconds = function (
      seconds,
      filtered,
      byhour,
      byminute,
  ...
  function parseOptions(options) {
    var opts = __assign(
      __assign({}, DEFAULT_OPTIONS$1),
      initializeOptions$1(options)
    );
    if (isPresent(opts.byeaster)) opts.freq = RRule.YEARLY;
    if (!(isPresent(opts.freq) && RRule.FREQUENCIES[opts.freq])) {
      throw new Error(
        "Invalid frequency: ".concat(opts.freq, " ").concat(options.freq)
      );
    }
  ...
  function parseDtstart(line) {
    var options = {};
    var dtstartWithZone = /DTSTART(?:;TZID=([^:=]+?))?(?::|=)([^;\s]+)/i.exec(
      line
    );
    if (!dtstartWithZone) {
      return options;
  ...
  function parseLine(rfcString) {
    ...
    switch (key.toUpperCase()) {
      ...
      default:
        throw new Error(
          "Unsupported RFC prop ".concat(key, " in ").concat(rfcString)
        );
    }
  }
                ...
                __spreadArray(
                  __spreadArray(
                    __spreadArray(
                      __spreadArray(
                        __spreadArray(
                          __spreadArray([], repeat(1, 31), true),
                          repeat(2, 28),
                          true
                        ),
                        repeat(3, 31),
              ...
              __spreadArray(
                __spreadArray(
                  __spreadArray(
                    __spreadArray(
                      __spreadArray(
                        __spreadArray(__spreadArray([], M31, true), M29, true),
                        M31,
                        true
                      ),
                      M30,
              ...
              __spreadArray(
                __spreadArray(
                  __spreadArray(
                    __spreadArray(
                      __spreadArray(
                        __spreadArray(__spreadArray([], M31, true), M28, true),
                        M31,
                        true
                      ),
                      M30,
  ...
  var NM30 = range(-30, 0);
  var NM31 = range(-31, 0);
  var NMDAY366MASK = __spreadArray(
    __spreadArray(
      __spreadArray(
        __spreadArray(
          __spreadArray(
  ...
  var NMDAY365MASK = __spreadArray(
    __spreadArray(
      __spreadArray(
        __spreadArray(
          __spreadArray(
  ...
  function parseInput(s, options) {
    ...
    lines.forEach(function (line) {
      ...
      switch (name.toUpperCase()) {
        ...
        case "RDATE":
          var _c =
              (_a = /RDATE(?:;TZID=([^:=]+))?/i.exec(line)) !== null &&
              _a !== void 0
                ? _a
                : [],
            rdateTzid = _c[1];
        ...
        case "EXRULE":
          if (parms.length) {
            throw new Error(
              "unsupported EXRULE parm: ".concat(parms.join(","))
            );
          }
  ...
  function buildRule(s, options) {
    ...
    if (
      ...
      exrulevals.forEach(function (val) {
        rset_1.exrule(
          new RRule(groomRruleOptions(val, dtstart, tzid), noCache)
        );
      });
  ...
  if (typeof CalendarFormObj !== "undefined") {
    CalendarFormObj.myCalendarConstructor = calConstructor;
  }

  if (typeof MeetingRoomObject !== "undefined") {
    MeetingRoomObject.myCalendarConstructor = calConstructor;
  }
